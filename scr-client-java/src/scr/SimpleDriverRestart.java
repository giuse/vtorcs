...
public class SimpleDriverRestart extends Controller{
  ...
  // GIUSE - whether to have a restart instead of finishing the track
	...
	public Action control(SensorModel sensors){
	    ...
	    else // car is not stuck
	    {
	        ...
	        action.brake = brake;
	        action.clutch = clutch;
	        if( sensors.getCurrentLapTime() > 5 ){ // restart after 5 secs
            restart = false;             // only one restart
